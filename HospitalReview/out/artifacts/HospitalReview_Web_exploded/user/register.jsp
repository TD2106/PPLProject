...
<div class="row">
    <div class="col-md-4 col-sm-6 col-xs-0">
        ...
        <form action="../register?action=<%=action%>" method="post">
            <div class="form-group">
                Email
                <br>
                <input id="input1" type="email" name="email" class="form-control" placeholder="Email" required autofocus>
            </div>
            <div class="form-group">
                Password
                <br>
    ...
    %>
            ...
            <div class="form-group">
                Hospital Admin Name
                <br>
                <input type="text" name="hospital_admin_name" class="form-control" required>
            </div>
            <div class="form-group">
                Hospital Admin Email
                <br>
                <input type="email" name="hospital_admin_email" class="form-control" required>
            </div>
    <%
        }
    %>
...
<script>
    ...
    %>
    $("#invalidReg").addClass("alert alert-danger");
    $("#invalidReg").text("User has already existed");
    $("#invalidReg").css("padding", "2%");
    <%
        }
    %>
</script>