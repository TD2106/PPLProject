...
<div class="row">
    <div class="col-md-4 col-sm-6 col-xs-0">
        ...
        <form action="../user/search.jsp" method="get">
            ...
            <div class="form-group">
                <%
                    List<GeneralSpecialty> all_specialty = GeneralSpecialtyDAO.getAllGeneralSpecialty();
                %>
                <select name="specialty" class="form-control">
                    <option value="">General Specialty</option>
                    <%
                        for(GeneralSpecialty specialty: all_specialty){
                    %>
                    <option value="<%=specialty.getGeneralSpecialtyID()%>"><%=specialty.getGeneralSpecialty()%></option>
                    <%
                        }
                    %>
                </select>
            ...
            <div class="form-group">
                <%
                    List<SpecificSpecialty> all_specific = SpecificSpecialtyDAO.getAllSpecificSpecialty();
                %>
                <select name="specific" class="form-control">
                    <option value="">Specific Specialty</option>
                    <%
                        for(SpecificSpecialty specific: all_specific){
                    %>
                    <option value="<%=specific.getSpecificSpecialtyID()%>"><%=specific.getSpecificSpecialty()%></option>
                    <%
                        }
                    %>
                </select>
            ...
            %>
                <select name="hospital" class="form-control">
                    ...
                    %>
                    <option value="<%=hospital.getHospitalID()%>"><%=hospital.getHospitalName()%></option>
                    <%
                        }
                    %>
                </select>
        ...
        <div id="containerAdsContact">
            ...
            <abbr title="Yahoo">
                <a href="mailto:huongung155@yahoo.com">
                    <img class="contactAds" src="http://jewel925.com/wp-content/uploads/yahoo-900x900.png">
                </a>
            </abbr>
        </div>
    </div>
