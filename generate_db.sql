...
-- -----------------------------------------------------
-- Table `HospitalReview`.`admin`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HospitalReview`.`admin` ;

CREATE TABLE IF NOT EXISTS `HospitalReview`.`admin` (
...
BEGIN
	DELETE FROM hospital WHERE user.user_id = hospital.hospital_id;
    DELETE FROM patient WHERE user.user_id = patient.patient_id;
END$$
...
BEGIN
	DELETE FROM comment WHERE patient.patient_id = comment.patient_id;
    DELETE FROM doctor_rating WHERE patient.patient_id = doctor_rating.patient_id;
    DELETE FROM favorite_hospital WHERE patient.patient_id = favorite_hospital.patient_id;
    DELETE FROM favorite_doctor WHERE patient.patient_id = favorite_doctor.patient_id;
    DELETE FROM patient_language WHERE patient.patient_id = patient_language.patient_id;
END$$
...
BEGIN
	DELETE FROM doctor WHERE doctor.hospital_id = hospital.hospital_id;
    DELETE FROM favorite_hospital WHERE favorite_hospital.hospital_id = hospital.hospital_id;
END$$
...
BEGIN
	UPDATE doctor SET doctor.general_specialty_id = null WHERE doctor.general_specialty_id = general_specialty.general_specialty_id;
    DELETE FROM specific_special_ty WHERE specific_specialty.general_specialty_id = general_specialty.general_specialty_id;
END$$
...
BEGIN
	DELETE FROM doctor_rating WHERE doctor.doctor_id = doctor_rating.doctor_id;
    DELETE FROM comment WHERE doctor.doctor_id = comment.doctor_id;
    DELETE FROM doctor_language WHERE doctor.doctor_id = doctor_language.doctor_id;
    DELETE FROM favorite_doctor WHERE doctor.doctor_id = favorite_doctor.doctor_id;
    DELETE FROM doctor_specific_specialty WHERE doctor.doctor_id = doctor_specific_specialty.doctor_id;
END$$
